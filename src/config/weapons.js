...
export const WEAPONS = {
  ...
  chrono: {
    ...
    desc: 'A bubble where time runs slow: ships and their shots inside crawl, your bullets speed up and hit harder the longer they spend inside. From Lv 10 it rewinds every ship inside to where it was 3 s earlier.',
    dmg: 6, rate: 1, range: 260, rangePerLevel: 6, ratio: 0.6, ratioPerLevel: 0.012, ratioMin: 0.25,
    boostPerSec: 0.6, boostMax: 2, rewindAt: 10, rewindEvery: 20, rewindBack: 3,
    dmgMul: 1.14, rateMul: 1.0,
    cost: 100, costGrowth: 1.32,
  ...
  singularity: {
    ...
    dmg: 0.25, pctMax: 0.8, bossPct: 0.08, rate: 1, range: 420, need: 800, trickle: 20, afterglowAt: 8, afterglowDur: 5,
    support: true,   // cannot be the starting weapon: it only charges from kills made by other slots
    dmgMul: 1.05, rateMul: 1.06,
    cost: 120, costGrowth: 1.34,
